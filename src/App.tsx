...
function App() {
	return (
		<div className="grid grid-cols-12 lg:grid-cols-[minmax(100px,_1fr),repeat(10,_1fr),minmax(100px,_1fr)] grid-rows-[minmax(100vh,_auto)] overflow-hidden py-[var(--header-height)]  w-svw text-xl">
