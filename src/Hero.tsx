      ...
      <div className="flex flex-grow flex-row justify-between">
        <div className="flex flex-col justify-between">
          <TextWriter
            ...
            text="Nicholas Stafford"
            className="text-text h-32 bg-gradient-to-t from-border to-white bg-clip-text px-6 py-0 text-8xl font-light text-transparent"
            delay={0.05}
          />
          <div className="mb-6 mt-0 min-h-32 max-w-[600px] px-6">
            <TextWriter
              // text="My name is Nicholas Stafford. I write code and make cool things. "
              text="
                 I am a developer based in Cleveland,
