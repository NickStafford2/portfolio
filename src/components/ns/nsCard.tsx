...
export const NsCard = ({
  ...
  return (
    <motion.div
      id={id}
      ref={ref}
      className={cn('min-h[50px] group relative w-full p-[2px]', className)}
      initial={{ opacity: 0 }} //
      animate={{
        opacity: inView ? 1 : 0,
      }}
    ...
    >
      ...
      {showImage ? (
        <div
          className={cn(
            'relative z-10 h-full w-full overflow-auto rounded-[22px] bg-cover',
            childContainerClassName
          )}
          style={{
            background: `linear-gradient(rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.8)), url(/backgrounds/pexels-cottonbro2.png)`,
          }}
        >
          {children}
        </div>
        ...
        <div
          className={cn(
            'relative z-10 h-full w-full overflow-auto rounded-[22px] bg-[var(--ns-background)] bg-cover',
            childContainerClassName
          )}
          style={{
            background: '',
