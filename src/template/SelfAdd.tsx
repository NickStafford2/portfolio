...
export default function SelfAdd() {
  return (
    <>
      <div
        id="aboutme"
        className="col-span-12 col-start-1 mt-32 flex min-h-[calc(100vh-84px)] scroll-mt-16 flex-col items-start gap-6 lg:flex-row 2xl:col-span-10 2xl:col-start-2">
        <NsCard
