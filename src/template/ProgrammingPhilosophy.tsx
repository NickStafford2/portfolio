...
export function ProgrammingPhilosophy() {
  return (
    <>
      <Title1
        id="thoughts"
        className="col-span-10 col-start-2 row-start-9 scroll-mt-8 pb-16 pt-32">
        Programming Hot Takes
      </Title1>
      <div className="col-span-10 col-start-2 row-start-10 grid grid-cols-1 items-start gap-4 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
        <NsCard>
